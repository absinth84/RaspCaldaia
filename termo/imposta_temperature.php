...
$redis->set('t_min_notte',$_GET["t_notte"]-0.1);
$redis->set('t_max_notte',$_GET["t_notte"]+0.1);
$redis->set('t_min_giorno',$_GET["t_giorno"]-0.1);
$redis->set('t_max_giorno',$_GET["t_giorno"]+0.1);
